...
const normalizeModuleType = (value, fallbackTitle = '') => {
  ...
  return normalizedTitle || 'custom-module';
};
    ...
    data: {
      ...
      modules: {
        create: COURSE_MODULES.map((module, index) => ({
          ...
          title: module.label,
          description: module.description,
          moduleType: normalizeModuleType(module.id, module.label),
          position: index,
        })),
      },
    },
    ...
    data: {
      ...
      modules: {
        create: sourceRoom.modules.map((module) => ({
          ...
          title: module.title,
          description: module.description || '',
          moduleType: normalizeModuleType(module.moduleType, module.title),
...
export const createModuleInRoom = async ({ teacherId, roomId, payload }) => {
  ...
  await prisma.module.create({
    data: {
      ...
      moduleType: normalizeModuleType(payload.moduleType, payload.title),
  ...
  await prisma.module.update({
    ...
    data: {
      ...
      ...(typeof payload.moduleType === 'string'
        ? { moduleType: normalizeModuleType(payload.moduleType, payload.title ?? module.title) }
        : {}),
      ...(typeof payload.isActive === 'boolean' ? { isActive: payload.isActive } : {}),
    },
  });
