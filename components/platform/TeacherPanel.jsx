...
export const TeacherPanel = ({
  ...
  const [questionForm, setQuestionForm] = useState({
    question: '',
    correctAnswer: '',
    responseType: DEFAULT_QUESTION_TYPE,
    skillCode: '',
    hint: '',
    explanation: '',
  });
  ...
  const selectedQuestionTypeMeta = useMemo(
    () => getQuestionTypeMeta(questionForm.responseType),
    [questionForm.responseType]
  );
  ...
  const handleCreateRoom = async () => {
    ...
    const room = await onCreateRoom(roomTitle);
        ...
        <div className="rounded-[28px] border border-slate-200 bg-slate-50 p-3 shadow-sm sm:p-4">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm text-slate-500">
              Ajoutez une salle pour organiser vos modules et questions.
            </p>
          </div>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex flex-wrap items-center justify-between gap-2">
                ...
                <span className="rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold text-slate-600">
                  {selectedRoom.modules.length} modules
                </span>
              </div>
              ...
              <div className="grid gap-2 md:grid-cols-[minmax(0,220px)_1fr]">
                ...
                <div className="rounded-2xl border border-slate-200 bg-white px-3 py-2.5 text-sm text-slate-600 shadow-sm">
                  ...
                  <p className="mt-1 font-medium text-slate-700">
                    {selectedQuestionTypeMeta.helperText}
                  </p>
                </div>
              </div>
              <input
        ...
        <div className="safe-x safe-y fixed inset-0 z-50 flex items-end justify-center bg-slate-950/45 sm:items-center">
          <div className="w-full max-w-sm rounded-[28px] bg-white p-4 shadow-lg sm:p-6">
            ...
            <p className="mt-2 text-sm text-slate-600">
              Cette action est irréversible. Tous les modules et questions
      ...
      {showDeleteModuleModal && (
        <div className="safe-x safe-y fixed inset-0 z-50 flex items-end justify-center bg-slate-950/45 sm:items-center">
          <div className="w-full max-w-sm rounded-[28px] bg-white p-4 shadow-lg sm:p-6">
            ...
            <p className="mt-2 text-sm text-slate-600">
              Cette action est irréversible. Toutes les questions associées
              seront supprimées.
            </p>
            <div className="mt-4 flex gap-3">
              <button
